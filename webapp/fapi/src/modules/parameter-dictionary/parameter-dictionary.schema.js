...
exports.updateParameterDictionarySchema = exports.createParameterDictionarySchema = exports.parameterDictionarySchema = void 0;
/**
 * Схема параметра словаря
 */
exports.parameterDictionarySchema = {
    type: "object",
    properties: {
        key: { type: "string" },
        labelRu: { type: "string" },
 ...
 */
exports.createParameterDictionarySchema = {
    type: "object",
    properties: {
        key: { type: "string" },
        labelRu: { type: "string" },
 ...
 */
exports.updateParameterDictionarySchema = {
    type: "object",
    properties: {
        labelRu: { type: "string" },
        labelEn: { type: "string" },
...
//# sourceMappingURL=parameter-dictionary.schema.js.map