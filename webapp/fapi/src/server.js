...
async function start() {
    try {
        ...
        const isDevPort = config_1.config.port === 7507 || process.env.PORT === '7507';
        if (isDevPort) {
            ...
            config_1.config.host = '0.0.0.0';
            config_1.config.port = 7507;
            ...
            config_1.config.domain = `http://85.209.90.173:7507`;
        ...
        console.log(`📚 Swagger docs available at ${config_1.config.domain}/api-docs`);
    }
    catch (err) {
