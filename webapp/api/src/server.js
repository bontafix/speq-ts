...
app.use("/api-docs", (req, res, next) => {
    ...
    const options = basePath
        ...
        : swaggerUiOptions;
    swagger_ui_express_1.default.setup(specWithServer, options)(req, res, next);
});
// Health check
app.get("/health", async (req, res) => {
    const dbHealth = await (0, pg_1.checkDatabaseHealth)();
    res.json({
        status: "ok",
        database: dbHealth,
...
// Routes
app.use("/api/equipment", equipment_routes_1.equipmentRouter);
// Error handler
